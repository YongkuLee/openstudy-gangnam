...
import chap17.model.CannotReplyArticleException;
import chap17.model.LastChildAleadyExistsException;
import chap17.model.ReplyingRequest;
...
public class ReplyArticleService {
	...
	private String getSearchMinSeqNum(Article parent) {
		...
		switch(parent.getLevel()) {
			case 0:
				searchMinLongValue = parentSeqLongValue / 1000000L * 100000000L;
				break;
			case 1:
